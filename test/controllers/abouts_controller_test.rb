...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { details: @about.details, name: @about.name, positon: @about.positon } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { details: @about.details, name: @about.name, positon: @about.positon } }
